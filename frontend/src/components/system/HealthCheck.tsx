    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className={cardCls}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Health Check</h3>
        </div>
        {health ? (
          <div className="space-y-3">
            <div className={rowCls}>
              <span className="text-sm text-slate-600 dark:text-slate-400">Status</span>
              <Badge variant={health.status === 'healthy' ? 'green' : health.status === 'degraded' ? 'amber' : 'red'} dot>{health.status}</Badge>
            </div>
            <div className={rowCls}>
              <span className="text-sm text-slate-600 dark:text-slate-400">AI Features</span>
      ...
      <div className={cardCls}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Readiness</h3>
        </div>
        {ready ? (
          <div className="space-y-3">
